export default {
    ...
    WhyForecastStreamflowDrought: {
        ...
        mapperDiagram: {
            ...
            caption: "Explore a map of current and forecast streamflow drought conditions across the conterminous United States and view detailed forecasts for individual sites on the <a href='https://water.usgs.gov/vizlab/streamflow-drought-forecasts/' target='_blank'>Streamflow Drought Assessment and Forecasting Tool</a>.",
