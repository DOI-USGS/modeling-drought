export default {
    ...
    WhyForecastStreamflowDrought: {
        ...
        paragraph1: "The food we eat, the water we drink, the clothes we buy, and the electricity we use depend on ample amounts of clean, accessible water. When water flowing through rivers and streams drops to unusually low levels—termed “<a href='https://water.usgs.gov/vizlab/what-is-drought/' target='_blank'>streamflow drought</a>”—water managers can have trouble allocating enough water to meet home, farm, business, and energy needs. To assist water managers, USGS developed Artificial Intelligence/Machine Learning (AI/ML) models that forecast streamflow drought up to 13 weeks (3 months) into the future (Carlisle, 2023; Hammond et al., 2025; McShane et al., 2025). Streamflow drought forecasts help decision makers anticipate periods of limited water availability so they can develop plans for ensuring the safety and health of their communities.",
        mapperDiagram: {
            mapPathDesktop: "map_desktop.png",
            mapPathMobile: "map_mobile.png",
            caption: "Explore a map of current and forecast streamflow drought conditions across the lower 48 states and view detailed forecasts for individual sites on the <a href='https://water.usgs.gov/vizlab/streamflow-drought-forecasts/' target='_blank'>Streamflow drought assessment and forecasting tool</a> (Corson-Dosch et al., 2025)."
        }        
    },
    ...
    HowModelStreamflowDrought: {
        ...
        paragraph1: "To forecast streamflow drought at <a href='https://www.usgs.gov/mission-areas/water-resources/science/usgs-national-streamgaging-network' target='_blank'>USGS streamgages</a> across the lower 48 states (the conterminous United States, or CONUS), USGS scientists built an AI/ML model (a long short-term memory, or LSTM, recurrent neural network) that predicts streamflow percentiles. AI/ML can’t predict streamflow percentiles on its own—scientists must first train the model to learn the relationship between input and output data for thousands of watersheds across the country.",
