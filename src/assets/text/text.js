export default {
    ...
    HowWellModelPerform: {
        ...
        forecastTrueFalseRightOrWrong: {
            ...
            questionNoDrought: "If the model <span class ='emph'>does not predict </span>streamflow <span class ='emph'>drought</span>, how often is it <span class='group-label true-neg'>right</span> or <span class='group-label false-neg'>wrong</span>?",
            questionDrought: "If the model <span class ='emph'>does predict </span>streamflow <span class ='emph'>drought</span>, how often is it <span class='group-label true-pos'>right</span> or <span class='group-label false-pos'>wrong</span>?",
