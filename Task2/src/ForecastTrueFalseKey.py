...
sankey_label(
    ...
    -0.5 * pad,
    -D,
    "Model predicts drought - " + str(round(D, 1)) + "%",
    "right",
    -width,
    label_alpha,
    gid="tf-label-YD",
...
sankey_label(
    ...
    0.5 * pad,
    ND,
    "Model predicts no drought - " + str(round(ND, 1)) + "%",
    "right",
    -width,
    label_alpha,
    gid="tf-label-ND",
...
sankey_label(
    ...
    -1.0 * pad,
    -D_ND,
    "Model wrongly\npredicted drought\n(false positive) - " + str(round(D_ND, 1)) + "%",
    "right",
    -width,
    label_alpha,
    gid="tf-label-YD-ND",
...
sankey_label(
    ...
    1.0 * pad,
    ND_D,
    "Model missed\nthe drought\n(false negative) - " + str(round(ND_D, 1)) + "%",
    "right",
    -width,
    label_alpha,
    gid="tf-label-ND-YD",
